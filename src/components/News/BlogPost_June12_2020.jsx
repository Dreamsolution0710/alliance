  ...
  return (
    <div>
      <HeaderSlot
        ...
        title={" Stretch Film Market Information June 2020"}
        router={[
          {
            title: "home",
            src: "/",
              ...
              <div className="col-span-2 px-[15px] text-center lg:text-left">
                ...
                <div className="text-left">
                  <div className="text-[#151515] mt-[30px] text-[15px]">
                    ...
                    <p className="mt-[20px]">
                      I hope all of you are staying safe as we are still working
                      towards opening our economy. Everyone here at Alliance
                      Plastics deeply appreciates our distributor partners and
                      hope you all are staying safe and healthy.
                    </p>
                    <p className="mt-[20px]">
                      Due to the price increase from June 1st from all major
                      ...
                      Steelflex, OP & SX2 material by 6% effective July 6, 2020.
                      We realize this date is later than most film suppliers but
                      we wanted to make sure the market was indeed moving toward
                      an increase. We have confirmation that this increase with
                      the potential of another increase to follow is indeed
                      coming soon.
                    </p>
                    <p className="mt-[20px]">
